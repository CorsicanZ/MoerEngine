...
public:
    ...
    static RESOURCE_API void FromFile(const std::filesystem::path& _path, ECS::Scene& _scene);
    ...
    static RESOURCE_API void LoadSceneFromCacheAsync(const std::filesystem::path& _path, ECS::Scene& _scene);
    static RESOURCE_API void LoadSceneFromCache(const std::filesystem::path& _path, ECS::Scene& _scene);
    //
protected:
